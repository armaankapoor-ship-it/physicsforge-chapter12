# physicsforge-chapter12 - Atoms Visual Notes

A premium-style, zero-cost visual notes website for **NCERT Class 12 Physics Chapter 12: Atoms**.
...
Create a GitHub repository named `physicsforge-chapter12`, push this project, and use GitHub Pages from the `gh-pages` branch.

```bash
VITE_BASE_PATH=/physicsforge-chapter12/ pnpm build
```

The included GitHub Actions workflow builds and publishes the site to `gh-pages`.
